...
SECRET_CIPHER = "This-is-neaps-secret-cypher"  # Only first 16 chars are used
...
a = Analysis(['./neaps_wx.py'],
             pathex=['/Users/gsorrentino/repo/neaps/neaps-cef'],
             binaries=[],
             datas=['neaps_lib', 'web'],
             hiddenimports=['cefpython3', 'wx', 'numpy'],
             hookspath=['.'],
             runtime_hooks=[],
             excludes=[],
