...
module.exports = {
  'run two simulations kanban type 2 with one leg': function (browser) {
    ...
    .url('http://localhost:8081')
      ...
      .waitForElementVisible('//*[@id="ticket0"]/table/tbody/tr', 60000)
      .end()
  },
  ...
  'run one simulation kanban type 2 with two standard legs ': function (browser) {
    browser
    .useXpath()
    .url('http://localhost:8081')
      .waitForElementVisible('//*[@id="simulatioTypeSelect"]', 5000)
      ...
      .setValue('//*[@id="leg1_target"]', '10')
      .setValue('//*[@id="leg1_wip"]', '1')
      .assert.cssClassNotPresent('//*[@id="cta_button"]', 'disabled')
      .click('//*[@id="cta"]')
      .waitForElementVisible('//*[@id="ticket0"]', 5000)
      // .pause(30000)
      ...
      .waitForElementVisible('//*[@id="ticket0"]/table/tbody/tr[@id="line0"]', 60000)
      .assert.elementPresent('//*[@id="ticket0"]/table/tbody/tr[@id="line1"]')
      .end()
  },
  'run one simulation kanban type 2 with two no montecarlo legs': function (browser) {
    browser
    .useXpath()
    .url('http://localhost:8081')
      .waitForElementVisible('//*[@id="simulatioTypeSelect"]', 5000)
  ...
  'run one simulation kanban type 2 with one standars leg and one no montecarlo leg': function (browser) {
    browser
    .useXpath()
    .url('http://localhost:8081')
      .waitForElementVisible('//*[@id="simulatioTypeSelect"]', 5000)
